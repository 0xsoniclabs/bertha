...
func dumpBlocks(data []BlockWithReceipts) string {
	...
	// This file is generated by go/test_data_generator/main.go
	 #![allow(dead_code)]
	use crate::{Address, Hash, HexConvert, Block, Transaction, TransactionReceipt, TransactionType, U256, AccessListEntry, SetCodeAuthorization, Log, receipts::PostStateOrStatus};
	`
