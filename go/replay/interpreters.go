...
// Registers Tosca's Rust based evmrs and C++ based evmzero interpreters. Both
// are loaded from shared libraries built in the local Tosca check-out the
// go.mod file points to; see the README for how to build them.
import (
