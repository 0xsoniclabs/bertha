...
type Block struct {
	...
	// State roots for alternative tree data structures
	VerkleStateRoot []byte         `protobuf:"bytes,20,opt,name=verkle_state_root,json=verkleStateRoot,proto3,oneof" json:"verkle_state_root,omitempty"`
	BinaryStateRoot []byte         `protobuf:"bytes,21,opt,name=binary_state_root,json=binaryStateRoot,proto3,oneof" json:"binary_state_root,omitempty"`
	Withdrawals     []*Withdrawal  `protobuf:"bytes,22,rep,name=withdrawals,proto3" json:"withdrawals,omitempty"`
	OmmerHeaders    []*OmmerHeader `protobuf:"bytes,23,rep,name=ommer_headers,json=ommerHeaders,proto3" json:"ommer_headers,omitempty"`
...
func (x *Block) GetVerkleStateRoot() []byte {
	if x != nil {
		return x.VerkleStateRoot
	}
	return nil
}

func (x *Block) GetBinaryStateRoot() []byte {
	if x != nil {
		return x.BinaryStateRoot
	}
	return nil
}
...
func (x *Block) GetOmmerHeaders() []*OmmerHeader {
	if x != nil {
		return x.OmmerHeaders
	}
	return nil
}
...
func (x *OmmerHeader) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OmmerHeader) ProtoMessage() {}

func (x *OmmerHeader) ProtoReflect() protoreflect.Message {
	mi := &file_block_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OmmerHeader.ProtoReflect.Descriptor instead.
func (*OmmerHeader) Descriptor() ([]byte, []int) {
	return file_block_proto_rawDescGZIP(), []int{1}
}

func (x *OmmerHeader) GetBeneficiary() []byte {
	if x != nil {
		return x.Beneficiary
	}
	return nil
...
func (x *OmmerHeader) GetNumber() uint64 {
	if x != nil {
		return x.Number
	}
	return 0
...
// Corresponds to bertha_types::Withdrawal
...
const file_block_proto_rawDesc = "" +
	"\n" +
	"\vblock.proto\x12\x05block\"\xd9\b\n" +
	"\x05Block\x12\x1f\n" +
	...
	"\x11verkle_state_root\x18\x14 \x01(\fH\x06R\x0fverkleStateRoot\x88\x01\x01\x12/\n" +
	"\x11binary_state_root\x18\x15 \x01(\fH\aR\x0fbinaryStateRoot\x88\x01\x01\x123\n" +
	"\vwithdrawals\x18\x16 \x03(\v2\x11.block.WithdrawalR\vwithdrawals\x127\n" +
	"\rommer_headers\x18\x17 \x03(\v2\x12.block.OmmerHeaderR\fommerHeadersB\x13\n" +
	...
	"\x0e_requests_hashB\x14\n" +
	"\x12_verkle_state_rootB\x14\n" +
	"\x12_binary_state_root\"G\n" +
	"\vOmmerHeader\x12 \n" +
	"\vbeneficiary\x18\x01 \x01(\fR\vbeneficiary\x12\x16\n" +
	...
	"\x06amount\x18\x04 \x01(\x04R\x06amount\"\xe8\x04\n" +
	"\vTransaction\x12)\n" +
...
var file_block_proto_goTypes = []any{
	...
	(*OmmerHeader)(nil),          // 1: block.OmmerHeader
	(*Withdrawal)(nil),           // 2: block.Withdrawal
	(*Transaction)(nil),          // 3: block.Transaction
	(*AccessListEntry)(nil),      // 4: block.AccessListEntry
	(*SetCodeAuthorization)(nil), // 5: block.SetCodeAuthorization
	(*TransactionReceipt)(nil),   // 6: block.TransactionReceipt
	(*Log)(nil),                  // 7: block.Log
}
var file_block_proto_depIdxs = []int32{
	3, // 0: block.Block.transactions:type_name -> block.Transaction
	6, // 1: block.Block.receipts:type_name -> block.TransactionReceipt
	2, // 2: block.Block.withdrawals:type_name -> block.Withdrawal
	1, // 3: block.Block.ommer_headers:type_name -> block.OmmerHeader
	4, // 4: block.Transaction.access_list:type_name -> block.AccessListEntry
	5, // 5: block.Transaction.authorization_list:type_name -> block.SetCodeAuthorization
	7, // 6: block.TransactionReceipt.logs:type_name -> block.Log
...
func file_block_proto_init() {
	...
	file_block_proto_msgTypes[3].OneofWrappers = []any{}
	file_block_proto_msgTypes[6].OneofWrappers = []any{
